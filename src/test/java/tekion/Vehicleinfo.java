...
public class Vehicleinfo extends TekionLogin{
	public static final By TAG=By.xpath("//XCUIElementTypeOther[@name='Tag *']/XCUIElementTypeOther[1]/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeTextField");
	public static final By VINNO=By.xpath("//XCUIElementTypeOther[@name='VIN *']/XCUIElementTypeOther/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTextField");
	public static final By MILES=By.xpath("//XCUIElementTypeOther[@name='Miles In *']/XCUIElementTypeOther[1]/XCUIElementTypeOther[1]/XCUIElementTypeOther/XCUIElementTypeTextField");
	public static final By PREVIOUSMILES=By.xpath("//XCUIElementTypeStaticText[contains(@name,'Last Mileage')]");
	
	public static final By USECAMERA=By.name("");
	public static final By CONNECTOBD =By.xpath("");
	public static final By SCANRFID =By.xpath("");
	public static final By PRODUCTIONDATE=By.name("Production Date * November 16, 2013");
