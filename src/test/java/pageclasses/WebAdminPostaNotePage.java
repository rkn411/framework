...
public class WebAdminPostaNotePage extends BaseClass {
	WebDriver driver;
	...
	public static final By POSTANOTE_TAGS_EQUIPMENTTAB_FIRSTGROUPTAB =By.linkText("First group");
	public static final By POSTANOTE_TAGS_EQUIPMENTTAB_FIRSTGROUPTAB_TEST3CHECKBOX =By.xpath("//label[contains(.,'Test3')]");
	public static final By POSTANOTE_TAGS_CANCELBTN =By.xpath("//button[@class='btn btn-default']");
	public static final By POSTANOTE_CLICKTOCOPY_USERSICON_USERSPOPUP_FRONTDESKCHKBOX =By.xpath("//html/body/div[2]/div/div[2]/div/div/div[2]/form/div/div/ul/li/fieldset/section/div[2]/label/i");
	public static final By CONVERTTOTASK_ASSIGNTO =By.xpath(".//*[@id='boardclass']/article/div/div/div[1]/div/form/fieldset/div/div/section[1]/label/select");
   ...
   // Constructor
	public WebAdminPostaNotePage(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void clkPostaTaskBtn(WebDriver driver) {
		try {
			waitForExpectedElement(driver, POSTATASKBTN, 180);
	...
	public void clkFirstgroupTab(WebDriver driver) {
		try {
			waitForExpectedElement(driver, POSTANOTE_TAGS_EQUIPMENTTAB_FIRSTGROUPTAB);
			driver.findElement(POSTANOTE_TAGS_EQUIPMENTTAB_FIRSTGROUPTAB).click();
		}
		catch (Exception e) {
			e.getMessage();
		}
	...
	public void clkTest3chkbox(WebDriver driver) {
		try {
			waitForExpectedElement(driver, POSTANOTE_TAGS_EQUIPMENTTAB_FIRSTGROUPTAB_TEST3CHECKBOX);
			driver.findElement(POSTANOTE_TAGS_EQUIPMENTTAB_FIRSTGROUPTAB_TEST3CHECKBOX).click();
		}
		catch (Exception e) {
			e.getMessage();
		}
	...
	public void clkLostandFound(WebDriver driver) {
		try {
