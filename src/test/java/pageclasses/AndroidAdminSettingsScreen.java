...
public class AndroidAdminSettingsScreen extends BaseClass {
	...
	public static final By SETTINGSBTN_PROFILEBTN_EMAILIDFLD=By.xpath("//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.FrameLayout[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.widget.ScrollView[1]/android.view.ViewGroup[1]/android.view.ViewGroup[1]/android.view.ViewGroup[3]/android.widget.TextView[1]");	
	...
	public static final By SETTINGSBTN_CHANGEHOTEL_ALEXHOTEL=By.xpath("//android.widget.TextView[@text='Alex Hotel']");
	public static final By SETTINGSBTN_CHANGEHOTEL_ALEXHOTEL_SAVE=By.xpath("//android.widget.TextView[@text='Save']");
	public static final By SETTINGSBTN_CHANGEHOTEL_ALEXHOTEL_CANCEL=By.xpath("//android.widget.TextView[@text='Cancel']");
	...
	public static final By ALEXHOTEL=By.xpath("//android.widget.TextView[@index='1']");
	public static final By SETTINGS_PROFILETXT=By.xpath("//android.widget.TextView[@text='Profile']");
	// Constructor
	public AndroidAdminSettingsScreen(AppiumDriver driver) {
		this.driver = driver;
	}
	//method to  verify logout verification
  ...
  //method to add verifications in login screen
	...
	//method to verify change hotel
	public String alexHotelVerification(AppiumDriver driver) {
		String strval = null;
		try {
			waitForExpectedElement(driver, ALEXHOTEL);
			strval = "pass";
		} catch (Exception e) {
			e.getMessage();
			strval = "fail";
	...
	//method to verify profile screen in settings
	...
	// method to click email id field
	public void fillEmailidFld(AppiumDriver driver) {
		try {
			waitForExpectedElement(driver, SETTINGSBTN_PROFILEBTN_EMAILIDFLD);
			driver.findElement(SETTINGSBTN_PROFILEBTN_EMAILIDFLD).getText();
		} catch (Exception e) {
			e.getMessage();
		}
	}
	...
	public void clkOldPasswordFld(AppiumDriver driver, String password) {
		try {
			...
			driver.findElement(SETTINGSBTN_ACCOUNTBTN_OLDPASSWORDFLD).click();
	...
	public void clkNewPasswordFld(AppiumDriver driver, String username) {
		try {
			...
			driver.findElement(SETTINGSBTN_ACCOUNTBTN_NEWPASSWORDFLD).click();
	...
	public void clkConfirmPasswordFld(AppiumDriver driver, String cnfmpasswd) {
		try {
			...
			driver.findElement(SETTINGSBTN_ACCOUNTBTN_CONFIRMNEWPASSWORDFLD).click();
	...
	public void clkAlexHotelBtn(AppiumDriver driver) {
		try {
			waitForExpectedElement(driver, SETTINGSBTN_CHANGEHOTEL_ALEXHOTEL);
			driver.findElement(SETTINGSBTN_CHANGEHOTEL_ALEXHOTEL).click();
		} catch (Exception e) {
			e.getMessage();
		}
		}
	...
	public void clkSaveBtn(AppiumDriver driver) {
		try {
			waitForExpectedElement(driver, SETTINGSBTN_CHANGEHOTEL_ALEXHOTEL_SAVE);
			driver.findElement(SETTINGSBTN_CHANGEHOTEL_ALEXHOTEL_SAVE).click();
		} catch (Exception e) {
			e.getMessage();
		}
	}
	...
	public void clkCancelBtn(AppiumDriver driver) {
		try {
			waitForExpectedElement(driver, SETTINGSBTN_CHANGEHOTEL_ALEXHOTEL_CANCEL);
			driver.findElement(SETTINGSBTN_CHANGEHOTEL_ALEXHOTEL_CANCEL).click();
			} catch (Exception e) {
			e.getMessage();
		}
		}
